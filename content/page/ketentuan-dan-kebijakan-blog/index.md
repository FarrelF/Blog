...
Dengan mengakses, menjelajah dan menggunakan blog ini, yaitu "Farrel Franqois Blog", maka Anda harus memahami dan menerima ketentuan di dalam halaman ini. Blog ini mencakup domain `farrelf.blog`, `farrel.franqois.id` dan seluruh sub-subdomainnya.

## Ketentuan Hukum

### Konten/Isi

Semua konten yang disediakan/dibuat oleh saya (sebagai 'pemilik' atau satu-satunya 'penulis' di dalam blog ini) hanya berdasarkan "apa adanya" (_"as-is" basis_). Saya percaya bahwa konten di dalam blog ini 'benar' dan 'akurat', karena saya telah melakukan 'riset' terlebih dahulu sebelum artikel diterbitkan, saya telah menyediakannya dengan itikad yang baik, tapi mungkin akan mengandung ketidakakuratan teknis atau kesalahan ketik.
...
- Blog ini menggunakan [Twemoji (Twitter Emoji)](https://jdecked.github.io/twemoji/) yang merupakan salah satu emoji yang dibuat oleh Twitter sebagai emoji bawaannya dan sekarang dikelola oleh [`jdecked`](https://github.com/jdecked). Dilisensikan di bawah ["Creative Commons Attribution 4.0 Internasional (CC BY 4.0)"](https://creativecommons.org/licenses/by/4.0/) untuk gambar emojinya dan [Lisensi MIT](https://github.com/jdecked/twemoji/blob/master/LICENSE) untuk [kode sumbernya](https://github.com/jdecked/twemoji).

- Mungkin untuk gambar, illustrasi, grafis atau/dan referensi lainnya yang telah saya dapatkan dari situs web atau blog lain akan menggunakan lisensi yang berbeda. Oleh karena itu, sebagai kredit (jika diizinkan), saya akan berikan atribusi berupa pencantuman judul atau nama dari gambar, illustrasi atau grafis, pembuatnya, sumber gambar dan juga lisensi yang digunakannya di akhir artikel atau halaman.
...
Dalam keadaan apa pun, saya tidak bertanggung jawab kepada Anda atau individu atau entitas lain untuk setiap kerugian secara langsung, atau secara tidak langsung, insidental, hukuman, khusus atau konsenkuensial yang terkait dengan penggunaan blog ini, kontennya atau situs web atau blog lainnya, termasuk tetapi tidak terbatas untuk kerusakan atau kehilangan pada perangkat keras, barang, program atau perangkat lunak (_Software_) atau/dan data lainnya.

Jadi segala risiko yang telah Anda timbulkan setelah mengakses, menjelajah, dan menggunakan blog ini dan kontennya, silakan tanggung sendiri.

### Kerahasiaan informasi yang dikirim oleh Anda

Tentu saja saya tidak ingin menerima informasi rahasia dari Anda melalui blog ini. Setiap informasi atau materi yang dikirim ke blog ini akan tidak lagi dianggap bersifat rahasia atau bukan suatu informasi yang dirahasiakan dan itu bisa dipublikasikan oleh saya dan juga pengunjung lainnya, bahkan oleh pihak ketiga lainnya.

Ini artinya, Anda mengakui bahwa Anda akan bertanggung jawab penuh atas semua konten atau/dan informasi yang telah Anda kirimkan kepada siapa pun, termasuk saya.
...
Selain itu, saya tidak bisa memberikan jaminan bahwa konten yang telah Anda akses itu tidak akan ada perubahan dengan konten-kontennya, saya berhak untuk mengubah, memperbarui atau menghapus konten kapan saja, tanpa pemberitahuan terlebih dahulu, dengan alasan apa pun.
...
## Kebijakan Komentar {#kebijakan-komentar}

### Penggunaan Pihak ke-3 dan Kebijakannya

Saya menggunakan [giscus](https://giscus.app) sebagai Sistem Komentar di dalam Blog ini. Ia merupakan sebuah sistem komentar pihak ke-3 yang diberdayakan oleh [GitHub Discussion](https://docs.github.com/en/discussions).

Meski tidak memiliki iklan dan tidak melacak penggunanya, tapi dengan berkomentar di sini, maka Anda telah tunduk, patuh dan setuju terhadap [segala kebijakan yang berlaku pada GitHub](https://docs.github.com/en/github/site-policy), termasuk tetapi tidak terbatas pada [kebijakan privasi](https://docs.github.com/en/github/site-policy/github-privacy-statement), [ketentuan layanan](https://docs.github.com/en/github/site-policy/github-terms-of-service), [pedoman komunitas](https://docs.github.com/en/github/site-policy/github-community-guidelines) dan lainnya.

### Topik Pembahasan

Anda berhak untuk mengomentari atau bertanya di sini, selama topik pembahasannya sesuai dengan artikel yang ada di blog ini, dan tidak di luar dari itu.

Ini artinya Anda tidak diperbolehkan untuk mengomentari yang tidak berkaitan dengan topik pembahasan dari artikel di blog ini, dengan alasan apa pun. Jika Anda melanggar aturan ini, maka komentar Anda akan saya hapus, jika berulang kali dilakukan (selama 3 kali) maka akun Anda akan saya blokir.

Saya telah menyediakan sebuah 'wadah' agar Anda bisa berkomentar di luar topik pembahasan artikel, bahkan di luar pembahasan yang ada di blog ini, yaitu sebuah halaman yang bernama ["Buku Tamu"](/buku-tamu).

Di halaman tersebut, Anda dapat berkomentar dengan topik apa pun, baik itu yang berkaitan dengan pembahasan di blog ini atau tidak sama sekali, selama Anda menyetujui dan mematuhi ketentuan dan kebijakan ini.
...
Jika Anda menyertakan/menyantumkan segala properti hak cipta atau HAKI milik orang lain di dalam kolom komentar, maka sebaiknya izin terlebih dahulu kepada pemilik hak ciptanya atau/dan menyantumkan atribusinya dengan benar. Jika ada perjanjian tertulis dari pemilik hak cipta, harap patuhi perjanjian tersebut jika ingin menggunakannya.

Bila Anda tidak menyantumkannya dengan benar, seperti tidak melakukan izin terlebih dahulu kepada pemilik hak cipta, atau/dan tidak mematuhi perjanjiannya, maka komentar Anda bisa saja dinyatakan melanggar hak cipta.
...
Segala bentuk penyebaran media pornografi, baik itu dalam bentuk foto, video, audio, tautan, dll, serta segala bentuk pelecehan seksual dan tindakan asusila di dalam kolom komentar tidak diperbolehkan dengan alasan apa pun.

Jika Anda melanggar aturan ini, maka akun Anda akan langsung saya blokir permanen, hal ini sudah saya peringati.

### Spam, Promosi dan Iklan

Segala bentuk spam dengan alasan apa pun di dalam kolom komentar itu tidak diperbolehkan, bahkan dengan alasan 'berbagi ilmu' sekalipun. Promosi atau iklan di sini juga tidak diperbolehkan.

